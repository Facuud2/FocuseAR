...
export class DatabaseService {
  ...
  static async createStudyPlan(studyPlan: Omit<StudyPlan, 'id' | 'createdAt' | 'updatedAt'>): Promise<string> {
    try {
  ...
  static async getUserStudyPlans(userId: string): Promise<StudyPlan[]> {
    try {
      ...
      console.error('❌ Error al obtener planes de estudio del usuario:', error);
      throw error;
    }
  }
