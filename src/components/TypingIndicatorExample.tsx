...
const TypingIndicatorExample: React.FC = () => {
  const [currentStyle, setCurrentStyle] = useState<'dots' | 'wave' | 'pulse'>(
    'dots',
  );
  ...
  return (
    ...
    >
            ...
            {styles.map((style) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  backgroundColor:
                    currentStyle === style ? '#3B82F6' : '#E5E7EB',
      ...
      >
        ...
        >
          <li>
            🎨 <strong>3 estilos de animación:</strong> Puntos rebotantes, onda
            y pulso
          </li>
          <li>
            📏 <strong>3 tamaños:</strong> Small, medium, large
          </li>
          <li>
            🎭 <strong>Personalizable:</strong> Colores, mensajes y avatares
          </li>
          <li>
            ⚡ <strong>Optimizado:</strong> Animaciones CSS suaves y eficientes
          </li>
          <li>
            🔄 <strong>Responsive:</strong> Se adapta a diferentes contenedores
          </li>
          <li>
            🎯 <strong>Accesible:</strong> Estados claros para usuarios
          </li>
          <li>
            🛠️ <strong>Reutilizable:</strong> Fácil integración en cualquier
            chat
          </li>
        </ul>
      </div>
