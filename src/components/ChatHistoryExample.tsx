...
const ChatHistoryExample: React.FC = () => {
  const [messages, setMessages] = useState<ExampleMessage[]>([
    ...
    {
      id: 4,
      message: "Perfecto, puedo ayudarte a crear un plan de estudios personalizado. ¿Qué materias estás cursando?",
      isUser: false,
    ...
    {
      id: 5,
      message: "Estoy cursando Matemáticas, Física y Química. Tengo exámenes en 2 semanas",
      isUser: true,
      timestamp: new Date(Date.now() - 360000), // 6 minutos atrás
    },
    {
      id: 6,
      message: "Excelente información. Voy a crear un plan optimizado para tus 3 materias considerando el tiempo disponible.",
      isUser: false,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <ul style={{
          ...
          <li>📜 <strong>Historial completo:</strong> Muestra todos los mensajes con scroll automático</li>
          <li>📊 <strong>Estado visual:</strong> Indicador de conexión y contador de mensajes</li>
          <li>🔄 <strong>Auto-scroll:</strong> Se desplaza automáticamente a nuevos mensajes</li>
          <li>⌨️ <strong>Indicador de escritura:</strong> Muestra cuando alguien está escribiendo</li>
          <li>🚫 <strong>Estado vacío:</strong> Mensaje personalizable cuando no hay mensajes</li>
          <li>📱 <strong>Responsive:</strong> Se adapta a diferentes tamaños de pantalla</li>
          <li>🎨 <strong>Personalizable:</strong> Altura, mensajes vacíos y comportamiento configurable</li>
        </ul>
      </div>
    </div>
  );
