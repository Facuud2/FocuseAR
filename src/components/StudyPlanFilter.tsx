...
const StudyPlanFilter: React.FC<StudyPlanFilterProps> = ({
  ...
  const applyFilter = React.useCallback(
    ...
    [studyPlans, selectedSubjects, onFilterChange, getNextExamPlan, getPendingPlans],
  );
  ...
  }, [activeFilter, applyFilter]); // Re-aplicar cuando cambien los planes o el filtro activo
