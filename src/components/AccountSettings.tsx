...
// Flags para ocultar secciones durante la preparación
const SHOW_PROFILE_SECTION = false;
const SHOW_CHANGE_PASSWORD_SECTION = false;
const SHOW_PREFERENCES_SECTION = false;
const SHOW_ACADEMIC_GOALS_SECTION = false;
const SHOW_PLANNER_SAVE_BUTTON = false;
              ...
              <div className="glitch-checkbox-wrapper">
                <label className="glitch-checkbox-container">
                  ...
                  <span
                    ...
                    data-text="Notificaciones del navegador"
                  >
                ...
                <label className="glitch-checkbox-container">
                  ...
                  <span
                    className="checkbox-label"
                    data-text="Alertas por correo electrónico"
                  >
                ...
                <label className="glitch-checkbox-container">
                  <input type="checkbox" name="option3" defaultChecked />
                  <div className="checkbox-box">
                    <div className="checkbox-mark"></div>
                  </div>
                  <span
                    className="checkbox-label"
                    data-text="Sonidos de notificación"
                  >
            ...
            <div className="modal">
              <form className="form">
                <div className="payment--options">
                  <button name="paypal" type="button">
                    ...
                    >
                      ...
                      ></path>
                      <path
                        d="M119.295,7.23l-2.807,17.858c-0.055,0.346,0.213,0.658,0.562,0.658h2.822c0.469,0,0.867-0.34,0.939-0.803 l2.768-17.536c-0.055-0.346-0.213-0.659-0.562-0.659h-3.16C119.578,6.749,119.338,6.953,119.295,7.23z"
                        fill="#179BD7"
                      ></path>
                      <path
                ...
                <div className="credit-card-info--form">
                  ...
                  <div className="input_container">
                    <label htmlFor="expiry-cvv" className="input_label">
                      Expiry Date / CVV
                    </label>
                    <div className="split">
                      <input
